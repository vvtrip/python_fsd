...
class HospitalVendingMachine(VendingMachine):
    ...
    snack_prices = {"candy": 3.50, "soda": 5.50, "chips": 1.50, "cookies": 5.50}
...
class SchoolVendingMachine(VendingMachine):
    ...
    student_debt = {"student1":45, "student2":55}
    snack_prices = {"candy": 3.00, "soda": 2.50, "chips": 1.00, "cookies": 2.50}
    ...
    def print_student_debt(self, student):
        print("The def print_student_debt(self, student):bt of %s with this vending machine is: $%d" % (student, SchoolVendingMachine.student_debt[student.capitalize()]))
...
school_machine = SchoolVendingMachine({"candy": 37, "soda": 17, "chips": 47, "cookies": 127}, "0534424", 2)
